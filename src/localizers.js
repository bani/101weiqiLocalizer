const ext101WeiqiLocalizers = {
    '': {
        texts: {
            ...
            '非会员只能选择公开题库' : 'Non-members can only choose the public problems bank',
            '会员可以选择精品题库，': 'Members can choose the premium problems bank',
        ...
        regExps: [
            {
                regExp: /第\s*(\d+)\s*题/,
                replace: (match, number) => `Problem ${number}`
            },
            {
                regExp: /第\s*(\d+)\s*問/,
                replace: (match, number) => `Problem ${number}`
    ...
    '/doquestionsetting': {
        texts: {
            ...
            '依据棋友当前水平设置' : 'Current player level',
            '继续做一题' : 'Back to problems',
            '做一题/签到 设置' : 'Problems Settings',
            '做题设置' : 'Problems Settings',
            '购买会员' : 'Buy membership',
            '次数设置' : 'Number of attempts',
            '题目来源' : 'Problems bank source',
            '难度设置' : 'Difficulty',
            '题型设置' : 'Problem types',
            '骗招题' : 'Tricky moves',
        },
